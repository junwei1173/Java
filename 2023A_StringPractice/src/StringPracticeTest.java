...
class StringPracticeTest extends StringPractice {
  ...
  void testNumPunctAfterNonPunct() {
	  assertEquals(1, StringPractice.numPunctAfterNonPunct("There's always money in my pocket."));
	  assertEquals(3, StringPractice.numPunctAfterNonPunct("There's the practice, so you'd better study."));
	  assertEquals(0, StringPractice.numPunctAfterNonPunct("BOOM!"));
	  assertEquals(2, StringPractice.numPunctAfterNonPunct("Hi, I'm sorry."));
  }
}
